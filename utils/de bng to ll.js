function(e, t) {
    ...
    e = parseInt(e, 10),
    t = parseInt(t, 10),
    a.setGridCoordinates(e, t);
    var n = a.getWGS84(),
        r = (a = n.getOSGB()).getGridRef(5).replace(/ /g, ""),
        o = "OK" == a.status;
    return {
        x: e,
        y: t,
        gr: r,
        lat: n.latitude.toPrecision(8),
        lng: n.longitude.toPrecision(8),
        status: o,
        statusDesc: a.status
    }
}
    ...
    for (precision = 5; precision >= 1; precision--)
    {
        ...
        if (gridRef)
        {
            ...
            var x,
                y;
            search:
            for (y = 0; y < GT_OSGB.prefixes.length; y++)
            {
    ...
    for (precision = 5; precision >= 1; precision--)
    {
        ...
        if (gridRef)
        {
            ...
            var x,
                y;
            search:
            for (x = 0; x < GT_Irish.prefixes.length; x++)
            {
